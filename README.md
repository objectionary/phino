...
```bash
cabal update
cabal install --overwrite-policy=always phino-0.0.0.70
phino --version
```
...
=== parse/phi ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      1285623.666 μs
  avg:        128562.367 μs
  min:        117536.191 μs
  max:        159667.519 μs
  std dev:    16574.574 μs
=== parse/xmir ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      7647254.426 μs
  avg:        764725.443 μs
  min:        699092.136 μs
  max:        830553.737 μs
  std dev:    46698.811 μs
=== rewrite/normalize ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      399993.887 μs
...
=== print/sweet/flat ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      4508962.897 μs
  avg:        450896.290 μs
  min:        411820.897 μs
  max:        481606.944 μs
  std dev:    24520.118 μs
=== print/salty/multiline ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      13746390.389 μs
  avg:        1374639.039 μs
  min:        1306918.930 μs
  max:        1449346.679 μs
  std dev:    40666.244 μs
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-05-23 at 18:53,
...
[benchmark-gha]: https://github.com/objectionary/phino/actions/runs/26340731472
