...
```bash
cabal update
cabal install --overwrite-policy=always phino-0.0.106
phino --version
```
...
=== parse/phi ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      1500387.987 μs
  avg:        150038.799 μs
  min:        133429.409 μs
  max:        186614.288 μs
  std dev:    17953.626 μs
=== parse/xmir ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      7914804.044 μs
  avg:        791480.404 μs
  min:        690852.935 μs
  max:        954546.394 μs
  std dev:    71263.135 μs
=== rewrite/normalize ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      579187.759 μs
...
=== print/sweet/multiline ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      4464627.406 μs
  avg:        446462.741 μs
  min:        366429.804 μs
  max:        551876.617 μs
  std dev:    71354.982 μs
=== print/sweet/flat ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      3937266.892 μs
  avg:        393726.689 μs
  min:        365162.075 μs
  max:        430047.878 μs
  std dev:    22670.052 μs
=== print/salty/multiline ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      15112960.502 μs
  avg:        1511296.050 μs
  min:        1387912.057 μs
  max:        1878317.222 μs
  std dev:    157696.391 μs
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-07-23 at 15:22,
...
[benchmark-gha]: https://github.com/objectionary/phino/actions/runs/30019349389
