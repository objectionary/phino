...
```bash
cabal update
cabal install --overwrite-policy=always phino-0.0.0.72
phino --version
```
...
=== parse/phi ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      1446955.287 μs
  avg:        144695.529 μs
  min:        130973.406 μs
  max:        172601.324 μs
  std dev:    15956.574 μs
=== parse/xmir ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      7822094.021 μs
  avg:        782209.402 μs
  min:        724263.957 μs
  max:        848031.736 μs
  std dev:    37013.055 μs
=== rewrite/normalize ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      472432.572 μs
...
=== print/sweet/multiline ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      4348945.916 μs
  avg:        434894.592 μs
  min:        410453.070 μs
  max:        458224.309 μs
  std dev:    16904.803 μs
=== print/sweet/flat ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      4167494.648 μs
  avg:        416749.465 μs
  min:        395966.138 μs
  max:        439580.540 μs
  std dev:    14464.456 μs
=== print/salty/multiline ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      14235047.199 μs
  avg:        1423504.720 μs
  min:        1389046.392 μs
  max:        1447618.093 μs
  std dev:    19513.831 μs
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-06-02 at 14:09,
...
[benchmark-gha]: https://github.com/objectionary/phino/actions/runs/26825128508
