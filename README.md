...
```bash
cabal update
cabal install --overwrite-policy=always phino-0.0.109
phino --version
```
...
=== parse/phi ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      1752826.156 μs
  avg:        175282.616 μs
  min:        161602.375 μs
  max:        207746.745 μs
  std dev:    17976.582 μs
=== parse/xmir ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      7325079.443 μs
  avg:        732507.944 μs
  min:        680467.071 μs
  max:        781477.714 μs
  std dev:    33069.603 μs
=== rewrite/normalize ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      735080.167 μs
  ...
  min:        56769.137 μs
  max:        100532.047 μs
  std dev:    15722.833 μs
=== print/sweet/multiline ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      3969209.900 μs
  avg:        396920.990 μs
  min:        382003.173 μs
  max:        413400.603 μs
  std dev:    9751.573 μs
=== print/sweet/flat ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      3878511.569 μs
  avg:        387851.157 μs
  min:        367599.186 μs
  max:        401269.316 μs
  std dev:    11094.278 μs
=== print/salty/multiline ===
  warmup:     3 iterations
  batches:    10 x 1
  total:      13896929.774 μs
  avg:        1389692.977 μs
  min:        1360571.793 μs
  max:        1424599.997 μs
  std dev:    18410.864 μs
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-08-06 at 14:15,
...
[benchmark-gha]: https://github.com/objectionary/phino/actions/runs/31095449442
