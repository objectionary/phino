    ...
    it "explains morphing rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  \\phinoName{lambda}"
            , "  \\phinoLabel{\\lambda}"
            , "  \\phinoPremise{ \\phinoEvaluate{ [[ B_1, L> F, B_2 ]] }{ n_1 } }"
            , "  \\phinoPremise{ \\phinoNormalize{ n_1 . \\tau }{ n_2 } }"
            , "  \\phinoPremise{ \\phinoMorph{ n_2 }{ e }{ n_3 } }"
            , "  \\phinoConclusion{ \\phinoMorph{ [[ B_1, L> F, B_2 ]] . \\tau }{ e }{ n_3 } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{dispatch}"
            , "  \\phinoLabel{disp}"
            ...
            , "  \\phinoConclusion{ \\phinoMorph{ Q }{ e }{ n_2 } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{dead}"
            , "  \\phinoLabel{dead}"
    ...
    it "explains dataization rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  \\phinoPremise{ \\phinoContextualize{ e_1 }{ [[ B_1, @ -> e_1, B_2 ]] }{ n_1 } }"
            , "  \\phinoPremise{ \\phinoNormalize{ n_1 }{ n_2 } }"
            , "  \\phinoPremise{ \\phinoDataize{ n_2 }{ e }{ \\delta_1 } }"
            , "  \\phinoConclusion{ \\phinoDataize{ [[ B_1, @ -> e_1, B_2 ]] }{ e }{ \\delta_1 } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{fire}"
            , "  \\phinoLabel{fire}"
            ...
            , "  \\phinoPremise{ \\phinoNormalize{ n_1 }{ n_2 } }"
            , "  \\phinoPremise{ \\phinoDataize{ n_2 }{ e }{ \\delta_1 } }"
            , "  \\phinoConclusion{ \\phinoDataize{ [[ B_1, L> F, B_2 ]] }{ e }{ \\delta_1 } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{none}"
            , "  \\phinoLabel{none}"
            ...
            , "  \\phinoLabel{norm}"
            , "  \\phinoPremise{ \\phinoMorph{ n }{ e }{ n_1 } }"
            , "  \\phinoPremise{ \\phinoDataize{ n_1 }{ e }{ \\delta_1 } }"
            , "  \\phinoConclusion{ \\phinoDataize{ n }{ e }{ \\delta_1 } }"
            , "\\end{phinoInference}"
            ]
        ]
