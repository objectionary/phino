    ...
    it "explains morphing rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  { \\phinoMorph{ [[ B_1, L> F, B_2 ]] . \\tau }{ e } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_1 . \\tau } }{ e } }"
            , "  { }"
            , "  { e_1 \\coloneqq \\phinoEvaluate{ [[ B_1, L> F, B_2 ]] } }"
            , "\\phinoMorphingRule{dispatch}"
            , "  { \\phinoMorph{ n . \\tau }{ e } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_1 . \\tau } }{ e } }"
            , "  { }"
            , "  { e_1 \\coloneqq \\phinoMorph{ n }{ e } }"
            , "\\phinoMorphingRule{application}"
            , "  { \\phinoMorph{ n ( \\tau -> e_1 ) }{ e } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_2 ( \\tau -> e_1 ) } }{ e } }"
            , "  { }"
            , "  { e_2 \\coloneqq \\phinoMorph{ n }{ e } }"
            , "\\phinoMorphingRule{applicationa}"
            , "  { \\phinoMorph{ n ( \\phiTerminal{\\alpha_{i}} -> e_1 ) }{ e } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_2 ( \\phiTerminal{\\alpha_{i}} -> e_1 ) } }{ e } }"
            , "  { }"
            , "  { e_2 \\coloneqq \\phinoMorph{ n }{ e } }"
            , "\\phinoMorphingRule{root}"
            , "  { \\phinoMorph{ Q }{ e } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e } }{ e } }"
            , "  { e \\not= Q }"
            , "  { }"
    ...
    it "explains dataization rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  { \\phinoDataize{ [[ B_1, @ -> e_1, B_2 ]] } }"
            , "  { \\phinoDataize{ \\phinoNormalize{ e_2 } } }"
            , "  { [ \\Delta, L ] \\cap ( B_1 \\cup B_2 ) = \\emptyset }"
            , "  { e_2 \\coloneqq \\ctx{ e_1 }{ [[ B_1, @ -> e_1, B_2 ]] } }"
