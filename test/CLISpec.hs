    ...
    it "explains morphing rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  { \\phinoMorph{ [[ B_1, L> F, B_2 ]] . \\tau }{ Q } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_1 . \\tau } }{ Q } }"
            , "  { }"
            ...
            , "  { \\phinoMorph{ \\phinoNormalize{ e_1 . \\tau } }{ Q } }"
            , "  { }"
            , "  { e_1 \\coloneqq \\phinoMorph{ n }{ Q } }"
            , "\\phinoMorphingRule{application}"
            , "  { \\phinoMorph{ n ( \\tau -> e_2 ) }{ Q } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_1 ( \\tau -> e_2 ) } }{ Q } }"
            , "  { }"
            , "  { e_1 \\coloneqq \\phinoMorph{ n }{ Q } }"
            , "\\phinoMorphingRule{applicationa}"
            , "  { \\phinoMorph{ n ( \\phiTerminal{\\alpha_{i}} -> e_2 ) }{ Q } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_1 ( \\phiTerminal{\\alpha_{i}} -> e_2 ) } }{ Q } }"
            , "  { }"
            , "  { e_1 \\coloneqq \\phinoMorph{ n }{ Q } }"
            , "\\phinoMorphingRule{root}"
            , "  { \\phinoMorph{ Q }{ Q } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e } }{ Q } }"
            , "  { e \\not= Q }"
            , "  { }"
