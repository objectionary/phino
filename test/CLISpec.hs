    ...
    it "explains morphing rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  { \\phinoMorph{ n ( \\tau -> e_2 ) }{ e } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_1 ( \\tau -> e_2 ) } }{ e } }"
            , "  { }"
            , "  { e_1 \\coloneqq \\phinoMorph{ n }{ e } }"
            , "\\phinoMorphingRule{applicationa}"
            , "  { \\phinoMorph{ n ( \\phiTerminal{\\alpha_{i}} -> e_2 ) }{ e } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_1 ( \\phiTerminal{\\alpha_{i}} -> e_2 ) } }{ e } }"
            , "  { }"
            , "  { e_1 \\coloneqq \\phinoMorph{ n }{ e } }"
