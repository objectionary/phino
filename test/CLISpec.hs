    ...
    it "explains morphing rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  \\phinoName{mf}"
            , "  \\phinoConclusion{ \\phinoMorph{ [[ B ]] }{ e }{ s }{ \\langle [[ B ]], s \\rangle } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{ml}"
            , "  \\phinoLabel{\\lambda}"
            , "  \\phinoPremise{ \\phinoEvaluate{ [[ B_1, L> F, B_2 ]] }{ e }{ s }{ \\langle n, s \\rangle } }"
            , "  \\phinoPremise{ \\phinoNormalize{ n . \\tau }{ n_1 } }"
            , "  \\phinoPremise{ \\phinoMorph{ n_1 }{ e }{ s }{ \\langle n_2, s \\rangle } }"
            , "  \\phinoConclusion{ \\phinoMorph{ [[ B_1, L> F, B_2 ]] . \\tau }{ e }{ s }{ \\langle n_2, s \\rangle } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{md}"
            , "  \\phinoCondition{ \\phinoNotFormation{ n } }"
            , "  \\phinoPremise{ \\phinoMorph{ n }{ e }{ s }{ \\langle n_1, s \\rangle } }"
            , "  \\phinoPremise{ \\phinoNormalize{ n_1 . \\tau }{ n_2 } }"
            , "  \\phinoPremise{ \\phinoMorph{ n_2 }{ e }{ s }{ \\langle n_3, s \\rangle } }"
            , "  \\phinoConclusion{ \\phinoMorph{ n . \\tau }{ e }{ s }{ \\langle n_3, s \\rangle } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{ma}"
            , "  \\phinoPremise{ \\phinoMorph{ n }{ e }{ s }{ \\langle n_1, s \\rangle } }"
            ...
            , "  \\phinoPremise{ \\phinoMorph{ n_2 }{ e }{ s }{ \\langle n_3, s \\rangle } }"
            , "  \\phinoConclusion{ \\phinoMorph{ n ( \\tau -> e_1 ) }{ e }{ s }{ \\langle n_3, s \\rangle } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{maa}"
            , "  \\phinoPremise{ \\phinoMorph{ n }{ e }{ s }{ \\langle n_1, s \\rangle } }"
            ...
            , "  \\phinoPremise{ \\phinoMorph{ n_2 }{ e }{ s }{ \\langle n_3, s \\rangle } }"
            , "  \\phinoConclusion{ \\phinoMorph{ n ( \\phiTerminal{\\alpha_{i}} -> e_1 ) }{ e }{ s }{ \\langle n_3, s \\rangle } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{root}"
            , "  \\phinoCondition{ e \\not= Q }"
            ...
            , "  \\phinoPremise{ \\phinoMorph{ n }{ e }{ s }{ \\langle n_1, s \\rangle } }"
            , "  \\phinoConclusion{ \\phinoMorph{ Q }{ e }{ s }{ \\langle n_1, s \\rangle } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{dead}"
            , "  \\phinoConclusion{ \\phinoMorph{ T }{ e }{ s }{ \\langle T, s \\rangle } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{xi}"
            , "  \\phinoConclusion{ \\phinoMorph{ \\phiTerminal{\\xi} }{ e }{ s }{ \\langle T, s \\rangle } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{mg}"
            , "  \\phinoConclusion{ \\phinoMorph{ Q }{ Q }{ s }{ \\langle T, s \\rangle } }"
            , "\\end{phinoMorphingInference}"
            ]
        ]
    ...
    it "explains dataization rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  \\phinoName{delta}"
            , "  \\phinoLabel{\\Delta}"
            , "  \\phinoConclusion{ \\phinoDataize{ [[ B_1, D> \\delta, B_2 ]] }{ e }{ s }{ \\langle \\delta, s \\rangle } }"
            ...
            , "  \\phinoPremise{ \\phinoDataize{ n_1 }{ e }{ s }{ \\langle \\delta, s \\rangle } }"
            , "  \\phinoConclusion{ \\phinoDataize{ [[ B_1, @ -> e_1, B_2 ]] }{ e }{ s }{ \\langle \\delta, s \\rangle } }"
            , "\\end{phinoDataizationInference}"
            , "\\begin{phinoDataizationInference}"
            , "  \\phinoName{fire}"
            , "  \\phinoPremise{ \\phinoEvaluate{ [[ B_1, L> F, B_2 ]] }{ e }{ s }{ \\langle n, s \\rangle } }"
            , "  \\phinoPremise{ \\phinoNormalize{ n }{ n_1 } }"
            , "  \\phinoPremise{ \\phinoDataize{ n_1 }{ e }{ s }{ \\langle \\delta, s \\rangle } }"
            , "  \\phinoConclusion{ \\phinoDataize{ [[ B_1, L> F, B_2 ]] }{ e }{ s }{ \\langle \\delta, s \\rangle } }"
            , "\\end{phinoDataizationInference}"
            , "\\begin{phinoDataizationInference}"
            , "  \\phinoName{none}"
            , "  \\phinoCondition{ [ D, L, @ ] \\cap \\lparen B \\rparen = \\emptyset }"
            , "  \\phinoConclusion{ \\phinoDataize{ [[ B ]] }{ e }{ s }{ \\langle --, s \\rangle } }"
            , "\\end{phinoDataizationInference}"
            , "\\begin{phinoDataizationInference}"
            , "  \\phinoName{end}"
            , "  \\phinoConclusion{ \\phinoDataize{ T }{ e }{ s }{ \\langle --, s \\rangle } }"
            , "\\end{phinoDataizationInference}"
            , "\\begin{phinoDataizationInference}"
            , "  \\phinoName{norm}"
            ...
            , "  \\phinoPremise{ \\phinoMorph{ n }{ e }{ s }{ \\langle n_1, s \\rangle } }"
            , "  \\phinoPremise{ \\phinoDataize{ n_1 }{ e }{ s }{ \\langle \\delta, s \\rangle } }"
            , "  \\phinoConclusion{ \\phinoDataize{ n }{ e }{ s }{ \\langle \\delta, s \\rangle } }"
            , "\\end{phinoDataizationInference}"
            ]
        ]
