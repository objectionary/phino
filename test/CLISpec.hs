  ...
  describe "explain" $ do
    it "explains single rule" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  \\phinoName{copy}"
            , "  \\phinoConclusion{ \\phinoNormalize{ [[ B_1, \\tau -> ?, B_2 ]] ( \\tau -> k ) }{ [[ B_1, \\tau -> k, B_2 ]] } }"
            , "\\end{phinoInference}"
            ]
        ]
    ...
    it "explains multiple rules" $
      testCLISucceeded
        ...
        ["\\phinoName{copy}", "\\phinoName{alpha}"]
    ...
    it "explains normalization rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "\\begin{phinoInference}"
            , "  \\phinoName{amiss}"
            , "  \\phinoCondition{ \\vert \\overline{ B } \\vert \\leq i }"
            , "  \\phinoConclusion{ \\phinoNormalize{ [[ B ]] ( \\phiTerminal{\\alpha_{i}} -> e ) }{ T } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{copy}"
            , "  \\phinoConclusion{ \\phinoNormalize{ [[ B_1, \\tau -> ?, B_2 ]] ( \\tau -> k ) }{ [[ B_1, \\tau -> k, B_2 ]] } }"
            ...
            , "\\begin{phinoInference}"
            , "  \\phinoName{dc}"
            , "  \\phinoConclusion{ \\phinoNormalize{ T ( \\tau -> e ) }{ T } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{dca}"
            , "  \\phinoConclusion{ \\phinoNormalize{ T ( \\phiTerminal{\\alpha_{i}} -> e ) }{ T } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{dd}"
            ...
            , "\\begin{phinoInference}"
            , "  \\phinoName{null}"
            , "  \\phinoConclusion{ \\phinoNormalize{ [[ B_1, \\tau -> ?, B_2 ]] . \\tau }{ T } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{over}"
            , "  \\phinoCondition{ \\tau \\not= \\phiTerminal{\\rho} }"
            , "  \\phinoConclusion{ \\phinoNormalize{ [[ B_1, \\tau -> e_1, B_2 ]] ( \\tau -> e_2 ) }{ T } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{phi}"
            , "  \\phinoLabel{\\phi}"
            , "  \\phinoCondition{ @ \\in B \\;\\text{and}\\; \\tau \\notin B }"
            , "  \\phinoConclusion{ \\phinoNormalize{ [[ B ]] . \\tau }{ [[ B ]] . @ . \\tau } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{stay}"
            , "  \\phinoConclusion{ \\phinoNormalize{ [[ B_1, \\phiTerminal{\\rho} -> e_1, B_2 ]] ( \\phiTerminal{\\rho} -> e_2 ) }{ [[ B_1, \\phiTerminal{\\rho} -> e_1, B_2 ]] } }"
            , "\\end{phinoInference}"
            , "\\begin{phinoInference}"
            , "  \\phinoName{stop}"
            , "  \\phinoCondition{ \\tau \\notin B \\;\\text{and}\\; @ \\notin B \\;\\text{and}\\; L \\notin B }"
    ...
    it "writes to target file" $
      bracket
        ...
        ( \(path, _) -> do
            ...
            content `shouldContain` "\\phinoName{alpha}"
        )
