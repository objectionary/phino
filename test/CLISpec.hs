    ...
    it "explains morphing rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  { \\phinoMorph{ \\phinoNormalize{ e . \\tau } }{ Q } }"
            , "  { }"
            ...
            , "  { \\phinoMorph{ \\phinoNormalize{ e . \\tau } }{ Q } }"
            , "  { }"
            , "  { e \\coloneqq \\phinoMorph{ n }{ Q } }"
            , "\\phinoMorphingRule{application}"
            , "  { \\phinoMorph{ n ( \\tau -> e ) }{ Q } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_1 ( \\tau -> e ) } }{ Q } }"
            , "  { }"
            , "  { e_1 \\coloneqq \\phinoMorph{ n }{ Q } }"
            , "\\phinoMorphingRule{applicationa}"
            , "  { \\phinoMorph{ n ( \\phiTerminal{\\alpha_{i}} -> e ) }{ Q } }"
            , "  { \\phinoMorph{ \\phinoNormalize{ e_1 ( \\phiTerminal{\\alpha_{i}} -> e ) } }{ Q } }"
            , "  { }"
            , "  { e_1 \\coloneqq \\phinoMorph{ n }{ Q } }"
