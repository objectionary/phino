          ...
          withTempFile "protocolXXXXXX.xml" $ \(path, stream) -> do
            ...
            lines records
              `shouldBe` [ "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                         ...
                         , "    <bind meta=\"𝛿1.2\" symbol=\"𝜎1\"/>"
                         , "    <bind meta=\"𝛿2.2\" bytes=\"40-1C-00-00-00-00-00-00\"/>"
                         , "    <answer meta=\"𝑛.2\" symbol=\"𝜎2\">Φ.number( φ ↦ ⟦ λ ⤍ 𝜎2 ⟧ )</answer>"
                         , "  </fire>"
                         , "</protocol>"
                         ]
          ...
          withTempFile "protocolXXXXXX.xml" $ \(path, stream) -> do
            ...
            lines records
              `shouldBe` [ "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                         ...
                         , "    <bind meta=\"𝛿1.1\" bytes=\"40-14-00-00-00-00-00-00\"/>"
                         , "    <fire λ=\"L_number_plus\" id=\"2\">"
                         , "      <bind meta=\"𝛿1.2\" bytes=\"40-18-00-00-00-00-00-00\"/>"
                         , "      <bind meta=\"𝛿2.2\" bytes=\"40-1C-00-00-00-00-00-00\"/>"
                         , "      <answer meta=\"𝑛.1\" symbol=\"𝜎1\">Φ.number( φ ↦ ⟦ λ ⤍ 𝜎1 ⟧ )</answer>"
                         , "    </fire>"
                         , "    <bind meta=\"𝛿2.1\" symbol=\"𝜎1\"/>"
                         , "    <answer meta=\"𝑛.2\" symbol=\"𝜎2\">Φ.number( φ ↦ ⟦ λ ⤍ 𝜎2 ⟧ )</answer>"
                         , "  </fire>"
                         , "</protocol>"
                         ]
          ...
          withTempFile "protocolXXXXXX.xml" $ \(path, stream) -> do
            ...
            lines records
              `shouldBe` [ "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                         ...
                         , "    <bind meta=\"𝛿1.1\" bytes=\"40-00-00-00-00-00-00-00\"/>"
                         , "    <bind meta=\"𝛿2.1\" bytes=\"40-08-00-00-00-00-00-00\"/>"
                         , "    <answer meta=\"𝑛.1\" symbol=\"𝜎1\">Φ.number( φ ↦ ⟦ λ ⤍ 𝜎1 ⟧ )</answer>"
                         , "  </fire>"
          ...
          withTempFile "protocolXXXXXX.xml" $ \(path, stream) -> do
            ...
            lines records
              `shouldBe` [ "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                         ...
                         , "    <bind meta=\"𝛿1.1\" bytes=\"40-00-00-00-00-00-00-00\"/>"
                         , "    <bind meta=\"𝛿2.1\" bytes=\"40-08-00-00-00-00-00-00\"/>"
                         , "    <answer meta=\"𝑛.1\" symbol=\"𝜎1\">Φ.number( φ ↦ ⟦ λ ⤍ 𝜎1, ρ ↦ ∅ ⟧ )</answer>"
                         , "  </fire>"
                         , "  <stuck λ=\"L_number_nope\"/>"
                         , "</protocol>"
                         ]
    ...
    it "explains morphing rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  \\phinoName{dead}"
            , "  \\phinoConclusion{ \\phinoMorph{ T }{ e_1 }{ s }{ T }{ s } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{ma}"
            , "  \\phinoPremise{ \\phinoMorph{ n_1 }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "  \\phinoPremise{ \\phinoNormalize{ n_2 ( \\tau_1 -> k_1 ) }{ n_3 } }"
            , "  \\phinoPremise{ \\phinoMorph{ n_3 }{ e_1 }{ s_2 }{ n_4 }{ s_3 } }"
            , "  \\phinoConclusion{ \\phinoMorph{ n_1 ( \\tau_1 -> k_1 ) }{ e_1 }{ s_1 }{ n_4 }{ s_3 } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{maa}"
            , "  \\phinoPremise{ \\phinoMorph{ n_1 }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "  \\phinoPremise{ \\phinoNormalize{ n_2 ( \\phiTerminal{\\alpha_{i1}} -> k_1 ) }{ n_3 } }"
            , "  \\phinoPremise{ \\phinoMorph{ n_3 }{ e_1 }{ s_2 }{ n_4 }{ s_3 } }"
            , "  \\phinoConclusion{ \\phinoMorph{ n_1 ( \\phiTerminal{\\alpha_{i1}} -> k_1 ) }{ e_1 }{ s_1 }{ n_4 }{ s_3 } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{maad}"
            , "  \\phinoCondition{ \\phinoNotAbsolute{ n_1 } }"
            , "  \\phinoPremise{ \\phinoMorph{ T }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "  \\phinoConclusion{ \\phinoMorph{ n ( \\phiTerminal{\\alpha_{i}} -> n_1 ) }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{mad}"
            , "  \\phinoCondition{ \\phinoNotAbsolute{ n_1 } }"
            , "  \\phinoPremise{ \\phinoMorph{ T }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "  \\phinoConclusion{ \\phinoMorph{ n ( \\tau -> n_1 ) }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{md}"
            , "  \\phinoCondition{ \\phinoNotFormation{ n_1 } }"
            , "  \\phinoPremise{ \\phinoMorph{ n_1 }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "  \\phinoPremise{ \\phinoNormalize{ n_2 . \\tau_1 }{ n_3 } }"
            , "  \\phinoPremise{ \\phinoMorph{ n_3 }{ e_1 }{ s_2 }{ n_4 }{ s_3 } }"
            , "  \\phinoConclusion{ \\phinoMorph{ n_1 . \\tau_1 }{ e_1 }{ s_1 }{ n_4 }{ s_3 } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{mf}"
            , "  \\phinoConclusion{ \\phinoMorph{ [[ B_1 ]] }{ e_1 }{ s }{ [[ B_1 ]] }{ s } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{mg}"
            ...
            , "  \\phinoName{ml}"
            , "  \\phinoLabel{\\lambda}"
            , "  \\phinoPremise{ \\phinoEvaluate{ [[ B_1, L> F_1, B_2 ]] }{ e_1 }{ s_1 }{ n_1 }{ s_2 } }"
            , "  \\phinoPremise{ \\phinoNormalize{ n_1 . \\tau_1 }{ n_2 } }"
            , "  \\phinoPremise{ \\phinoMorph{ n_2 }{ e_1 }{ s_2 }{ n_3 }{ s_3 } }"
            , "  \\phinoConclusion{ \\phinoMorph{ [[ B_1, L> F_1, B_2 ]] . \\tau_1 }{ e_1 }{ s_1 }{ n_3 }{ s_3 } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{mphi}"
            , "  \\phinoLabel{\\varphi}"
            , "  \\phinoCondition{ @ \\in B_1 \\;\\text{and}\\; \\tau_1 \\notin B_1 \\;\\text{and}\\; L \\notin B_1 }"
            , "  \\phinoPremise{ \\phinoNormalize{ [[ B_1 ]] . @ . \\tau_1 }{ n_1 } }"
            , "  \\phinoPremise{ \\phinoMorph{ n_1 }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "  \\phinoConclusion{ \\phinoMorph{ [[ B_1 ]] . \\tau_1 }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{universe}"
            , "  \\phinoLabel{\\Phi}"
            ...
            , "  \\phinoPremise{ \\phinoMorph{ n_1 }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "  \\phinoConclusion{ \\phinoMorph{ Q }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "\\end{phinoMorphingInference}"
            , "\\begin{phinoMorphingInference}"
            , "  \\phinoName{xi}"
            , "  \\phinoPremise{ \\phinoMorph{ T }{ e_1 }{ s_1 }{ n_1 }{ s_2 } }"
            , "  \\phinoConclusion{ \\phinoMorph{ \\phiTerminal{\\xi} }{ e_1 }{ s_1 }{ n_1 }{ s_2 } }"
            , "\\end{phinoMorphingInference}"
            ]
        ]
    ...
    it "explains dataization rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  \\phinoPremise{ \\phinoNormalize{ e_3 }{ n_1 } }"
            , "  \\phinoPremise{ \\phinoDataize{ n_1 }{ e_1 }{ s_1 }{ \\delta_1 }{ s_2 } }"
            , "  \\phinoConclusion{ \\phinoDataize{ [[ B_1, @ -> e_2, B_2 ]] }{ e_1 }{ s_1 }{ \\delta_1 }{ s_2 } }"
            , "\\end{phinoDataizationInference}"
            , "\\begin{phinoDataizationInference}"
            , "  \\phinoName{delta}"
            , "  \\phinoLabel{\\Delta}"
            , "  \\phinoConclusion{ \\phinoDataize{ [[ B_1, D> \\delta_1, B_2 ]] }{ e_1 }{ s }{ \\delta_1 }{ s } }"
            , "\\end{phinoDataizationInference}"
            , "\\begin{phinoDataizationInference}"
            , "  \\phinoName{fire}"
            , "  \\phinoPremise{ \\phinoEvaluate{ [[ B_1, L> F_1, B_2 ]] }{ e_1 }{ s_1 }{ n_1 }{ s_2 } }"
            , "  \\phinoPremise{ \\phinoDataize{ n_1 }{ e_1 }{ s_2 }{ \\delta_1 }{ s_3 } }"
            , "  \\phinoConclusion{ \\phinoDataize{ [[ B_1, L> F_1, B_2 ]] }{ e_1 }{ s_1 }{ \\delta_1 }{ s_3 } }"
            , "\\end{phinoDataizationInference}"
            , "\\begin{phinoDataizationInference}"
            , "  \\phinoName{none}"
            , "  \\phinoCondition{ [ D \\char44{} L \\char44{} @ ] \\cap B_1 = \\emptyset }"
            , "  \\phinoPremise{ \\phinoDataize{ T }{ e_1 }{ s_1 }{ \\delta_1 }{ s_2 } }"
            , "  \\phinoConclusion{ \\phinoDataize{ [[ B_1 ]] }{ e_1 }{ s_1 }{ \\delta_1 }{ s_2 } }"
            , "\\end{phinoDataizationInference}"
            , "\\begin{phinoDataizationInference}"
            , "  \\phinoName{norm}"
            , "  \\phinoCondition{ \\phinoNotFormation{ n_1 } \\;\\text{and}\\; n_1 \\not= T }"
            , "  \\phinoPremise{ \\phinoMorph{ n_1 }{ e_1 }{ s_1 }{ n_2 }{ s_2 } }"
            , "  \\phinoPremise{ \\phinoDataize{ n_2 }{ e_1 }{ s_2 }{ \\delta_1 }{ s_3 } }"
            , "  \\phinoConclusion{ \\phinoDataize{ n_1 }{ e_1 }{ s_1 }{ \\delta_1 }{ s_3 } }"
            , "\\end{phinoDataizationInference}"
            ]
        ]
    ...
    it "explains contextualization rules" $
      testCLISucceeded
        ...
        [ unlines
            ...
            , "  \\phinoName{ca}"
            , "  \\phinoPremise{ \\phinoContextualize{ n_1 }{ k_1 }{ n_2 } }"
            , "  \\phinoPremise{ \\phinoContextualize{ e_1 }{ k_1 }{ n_3 } }"
            , "  \\phinoConclusion{ \\phinoContextualize{ n_1 ( \\tau_1 -> e_1 ) }{ k_1 }{ n_2 ( \\tau_1 -> n_3 ) } }"
            , "\\end{phinoContextualizationInference}"
            , "\\begin{phinoContextualizationInference}"
            , "  \\phinoName{caa}"
            , "  \\phinoPremise{ \\phinoContextualize{ n_1 }{ k_1 }{ n_2 } }"
            , "  \\phinoPremise{ \\phinoContextualize{ e_1 }{ k_1 }{ n_3 } }"
            , "  \\phinoConclusion{ \\phinoContextualize{ n_1 ( \\phiTerminal{\\alpha_{i1}} -> e_1 ) }{ k_1 }{ n_2 ( \\phiTerminal{\\alpha_{i1}} -> n_3 ) } }"
            , "\\end{phinoContextualizationInference}"
            , "\\begin{phinoContextualizationInference}"
            , "  \\phinoName{cd}"
            , "  \\phinoPremise{ \\phinoContextualize{ n_1 }{ k_1 }{ n_2 } }"
            , "  \\phinoConclusion{ \\phinoContextualize{ n_1 . \\tau_1 }{ k_1 }{ n_2 . \\tau_1 } }"
            , "\\end{phinoContextualizationInference}"
            , "\\begin{phinoContextualizationInference}"
            , "  \\phinoName{cf}"
            , "  \\phinoConclusion{ \\phinoContextualize{ [[ B_1 ]] }{ k_1 }{ [[ B_1 ]] } }"
            , "\\end{phinoContextualizationInference}"
            , "\\begin{phinoContextualizationInference}"
            , "  \\phinoName{cg}"
            , "  \\phinoConclusion{ \\phinoContextualize{ Q }{ k_1 }{ Q } }"
            , "\\end{phinoContextualizationInference}"
            , "\\begin{phinoContextualizationInference}"
            , "  \\phinoName{ct}"
            , "  \\phinoConclusion{ \\phinoContextualize{ T }{ k_1 }{ T } }"
            , "\\end{phinoContextualizationInference}"
            , "\\begin{phinoContextualizationInference}"
            , "  \\phinoName{cxi}"
            , "  \\phinoConclusion{ \\phinoContextualize{ \\phiTerminal{\\xi} }{ k_1 }{ k_1 } }"
            , "\\end{phinoContextualizationInference}"
            ]
        ]
