...
defaultReduceContext loc = ReduceContext loc loc Nothing 25 25 (Steps 250 0) Nothing 1 False True False False Nothing Morphing [] Map.empty emptyLambdas buildTerm reduction evaluation fired dontSaveStep dontSaveEval
